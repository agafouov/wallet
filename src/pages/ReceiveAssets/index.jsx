...
// import { BrowserRouter as Router, Route, use } from 'react-router-dom';
    ...
    <>
      ...
      <div className="VFOP">
        <div className="mjig ODmG LQUd Hk4R Ntau">
          <div onClick={() => handleClick("TON")} className="r2DG tizz">
                  ...
                  <div className="vZ3f">
                    <div className="MKKc TKvX vc2p sJpg" alt="radio">
                      ...
                      >
                        ...
                        <g clip-path="url(#__lottie_element_423)">
                          <g
                            style={{ display: "block" }}
          ...
          <div onClick={() => handleClick("USDT")} className="r2DG tizz">
            <div className="P13Q dAgC">
              <div className="t1CP Bcb3">
                <div className="RkvK">
                  <svg
