  ...
  return (
    <>
      <form className="taoq Ri1i">
        ...
        <div className="vhab">
          <button onClick={btn1} type="button" className="r2DG kcJb">
            <div className="P13Q">
          ...
          <button onClick={btn2} type="button" className="r2DG kcJb">
            <div className="P13Q">
              <div color="text" variant="button1" className="cpHh KbDJ Ka5f">
                100&nbsp;TON
              </div>
          ...
          <button onClick={btn3} type="button" className="r2DG kcJb">
            <div className="P13Q">
              <div color="text" variant="button1" className="cpHh KbDJ Ka5f">
                300&nbsp;TON
              </div>
          ...
          <button onClick={btn4} type="button" className="r2DG kcJb">
            <div className="P13Q">
              <div color="text" variant="button1" className="cpHh KbDJ Ka5f">
                600&nbsp;TON
              </div>
